...
import com.fengjian.crowd.entity.ParamData;
import com.fengjian.crowd.entity.Student;
...
public class TestHandler {
    ...
    public ResultEntity<Student> testComposeObject(@RequestBody Student student, HttpServletRequest request){
        boolean judgeResult = CrowdUtil.judgeRequestType(request);
        logger.info("judge result = " + judgeResult);
